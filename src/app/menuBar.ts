  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        command('edit.find', t),
        separator,
        command('edit.wordCompletion', t),
        command('vocabulary.addWord', t),
        command('vocabulary.ignoreWord', t),
        command('vocabulary.open', t),
      ],
    },
    {
      kind: 'submenu',
